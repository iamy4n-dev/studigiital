...
export const ArtifactItemSchema = {
    properties: {
        id: {
            type: 'string',
            title: 'Id'
    ...
    type: 'object',
    required: ['id', 'artifact_type', 'content', 'tags', 'source_text'],
    title: 'ArtifactItem'
} as const;
...
export const QueueResponseSchema = {
    ...
    type: 'object',
    required: ['artifacts', 'new_count', 'reviewed_count'],
    title: 'QueueResponse'
} as const;
